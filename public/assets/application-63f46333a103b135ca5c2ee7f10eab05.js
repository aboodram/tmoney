...
// //define(["/Raphael.js"], function (Raphael) {
...
window.addEventListener('DOMContentLoaded', function() {
	...
	// 	request.onreadystatechange = function () {
	// 		if (request.readyState == 4 && request.status == 200) {
	// 			document.getElementById('test-xml').innerHTML = request.responseText;
	// 		}
	// 	};

	// 	XMLHttpRequest.open('GET', '/js', true);
...
window.addEventListener('DOMContentLoaded', function () {
	var photoPopupSlider = function () {
		...
		setImageTags = function () {
			for (var i = 0; i > imageList.length; i++) {
				photoDiv.innerHTML = '<img src="'+ imageList[i] + '" alt="Popup Photos" />'; 
			}
		},
